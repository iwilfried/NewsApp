...
class MostViewNews extends StatefulWidget {
  const MostViewNews({Key key}) : super(key: key);

  @override
  State<MostViewNews> createState() => _MostViewNewsState();
}

class _MostViewNewsState extends State<MostViewNews> {
  final newsList = [
    {
